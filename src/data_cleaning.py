...
#income data
df_income_full = pd.read_csv("data/ACS_14_5YR_income/ACS_14_5YR_S1901_with_ann.csv", 
                        encoding = "ISO-8859-1", skiprows=1)
...
# first, we need to get those column names
income_cols = df_income_full.columns.tolist()


# merge the household mean and median income into the df_main
...
df_main.to_excel('data/combined_df.xlsx')
...
# it looks like there are a fair number of NaN in the df, lets see how many:
df_main.isna().sum()
